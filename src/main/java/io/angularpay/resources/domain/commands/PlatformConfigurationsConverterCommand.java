...
import io.angularpay.resources.models.platform.*;
...
import static io.angularpay.resources.exceptions.ErrorCode.INVALID_MESSAGE_ERROR;
import static io.angularpay.resources.models.platform.PlatformConfigurationSource.HASH;
